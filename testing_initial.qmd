...
shapefile_path = r"C:\Users\Mitch\Documents\GitHub\final_project\Seattle_PD_beats.zip"
...
calls_911_geo=pd.merge(calls_911_agg,gdf,on="Beat",how="outer")
#drop the points and shapes over map of seattle:
```
