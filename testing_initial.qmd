...
# buffering around our points
buff_police = police_gdf.copy()
buff_rest = rest_gdf_filtered.copy()
police_range = 10 * 1609.34
rest_range = 5 * 1609.34
buff_police['geometry'] = buff_police['geometry'].buffer(police_range)
buff_rest['geometry'] = buff_rest['geometry'].buffer(rest_range)
